...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IMessageContract ContractToViewAdapter(Start9.Api.Contracts.IMessageContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageContractContract ViewToContractAdapter(Sideshow.Views.IMessageContract view)
        {
            if ((view == null))
            {
                return null;
