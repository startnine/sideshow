...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IConfigurationEntry ContractToViewAdapter(Start9.Api.Contracts.IConfigurationEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationEntryContract ViewToContractAdapter(Sideshow.Views.IConfigurationEntry view)
        {
            if ((view == null))
            {
                return null;
