...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IModuleInstance ContractToViewAdapter(Start9.Api.Contracts.IModuleInstanceContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleInstanceContract ViewToContractAdapter(Sideshow.Views.IModuleInstance view)
        {
            if ((view == null))
            {
                return null;
