...
namespace Sideshow.Adapters
{
    ...
    public class IMessageContractToViewAddInAdapter : Sideshow.Views.IMessage
    {
        ...
        public Sideshow.Views.IMessageEntry MessageEntry
        {
            get
            {
                return Sideshow.Adapters.IMessageEntryAddInAdapter.ContractToViewAdapter(_contract.MessageEntry);
            }
        }
