...
namespace Sideshow.Adapters
{
    ...
    public class IModuleInstanceContractToViewAddInAdapter : Sideshow.Views.IModuleInstance
    {
        ...
        public Sideshow.Views.IModule Instance
        {
            get
            {
                return Sideshow.Adapters.IModuleAddInAdapter.ContractToViewAdapter(_contract.Instance);
            }
        }
