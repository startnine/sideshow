...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.MessageReceivedEventArgs ContractToViewAdapter(Start9.Api.Contracts.IMessageReceivedEventArgsContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageReceivedEventArgsContract ViewToContractAdapter(Sideshow.Views.MessageReceivedEventArgs view)
        {
            if ((view == null))
            {
                return null;
