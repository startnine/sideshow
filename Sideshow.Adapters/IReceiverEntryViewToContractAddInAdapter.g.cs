...
namespace Sideshow.Adapters
{
    ...
    {
        private Sideshow.Views.IReceiverEntry _view;
        private System.Collections.Generic.Dictionary<Start9.Api.Contracts.IMessageEventHandlerContract, System.EventHandler<Sideshow.Views.MessageReceivedEventArgs>> MessageReceived_handlers;
        public IReceiverEntryViewToContractAddInAdapter(Sideshow.Views.IReceiverEntry view)
        {
            _view = view;
            MessageReceived_handlers = new System.Collections.Generic.Dictionary<Start9.Api.Contracts.IMessageEventHandlerContract, System.EventHandler<Sideshow.Views.MessageReceivedEventArgs>>();
        }
        ...
        internal Sideshow.Views.IReceiverEntry GetSourceView()
        {
            return _view;
        }
    }
