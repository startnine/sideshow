...
namespace Sideshow.Adapters
{
    ...
    public class IReceiverEntryContractToViewAddInAdapter : Sideshow.Views.IReceiverEntry
    {
        private Start9.Api.Contracts.IReceiverEntryContract _contract;
        private System.AddIn.Pipeline.ContractHandle _handle;
        private Sideshow.Adapters.IMessageEventHandlerViewToContractAddInAdapter MessageReceived_Handler;
        private static System.Reflection.MethodInfo s_MessageReceivedEventAddFire;
		public event System.EventHandler<Sideshow.Views.MessageReceivedEventArgs>MessageReceived{
			add{
        ...
        public IReceiverEntryContractToViewAddInAdapter(Start9.Api.Contracts.IReceiverEntryContract contract)
        {
            ...
            MessageReceived_Handler = new Sideshow.Adapters.IMessageEventHandlerViewToContractAddInAdapter(this, s_MessageReceivedEventAddFire);
        }
        ...
        private event System.EventHandler<Sideshow.Views.MessageReceivedEventArgs> _MessageReceived;
        ...
        internal virtual void Fire_MessageReceived(Sideshow.Views.MessageReceivedEventArgs args)
        {
            if ((_MessageReceived == null))
            {
            }
