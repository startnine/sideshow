...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IReceiverContract ContractToViewAdapter(Start9.Api.Contracts.IReceiverContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverContractContract ViewToContractAdapter(Sideshow.Views.IReceiverContract view)
        {
            if ((view == null))
            {
                return null;
