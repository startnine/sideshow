...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IHost ContractToViewAdapter(Start9.Api.Contracts.IHostContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IHostContract ViewToContractAdapter(Sideshow.Views.IHost view)
        {
            if ((view == null))
            {
                return null;
