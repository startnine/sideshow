...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IReceiverEntry ContractToViewAdapter(Start9.Api.Contracts.IReceiverEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverEntryContract ViewToContractAdapter(Sideshow.Views.IReceiverEntry view)
        {
            if ((view == null))
            {
                return null;
