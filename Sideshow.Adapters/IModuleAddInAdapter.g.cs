...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IModule ContractToViewAdapter(Start9.Api.Contracts.IModuleContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleContract ViewToContractAdapter(Sideshow.Views.IModule view)
        {
            if ((view == null))
            {
                return null;
