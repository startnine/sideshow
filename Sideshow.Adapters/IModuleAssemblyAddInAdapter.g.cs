...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IModuleAssembly ContractToViewAdapter(Start9.Api.Contracts.IModuleAssemblyContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleAssemblyContract ViewToContractAdapter(Sideshow.Views.IModuleAssembly view)
        {
            if ((view == null))
            {
                return null;
