...
namespace Sideshow.Adapters
{
    ...
    {
        internal static Sideshow.Views.IMessage ContractToViewAdapter(Start9.Api.Contracts.IMessageContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageContract ViewToContractAdapter(Sideshow.Views.IMessage view)
        {
            if ((view == null))
            {
                return null;
